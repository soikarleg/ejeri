...
$sql = "SELECT * FROM phrases WHERE cs='$secteur' and designation LIKE '$term%' and type='DEV' order by designation asc";
...
foreach ($results as $v) {
  $label = (stripslashes(($v['designation'])));
  $value = $v['numero'];
  $tev = array('label' => $label, 'numero' => $value);
