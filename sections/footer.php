 <footer id="footer" class="footer dark-background">
     ...
     <div class="row gy-4">
       ...
       <div class="col-lg-3">
         <nav class="q-links" aria-label="Accès comptes">
           <a href="https://ejeri.fr/services/villes.php" rel="noopener"><i class="bi bi-person-check"></i> Villes desservies</a>
   ...
   <div class="container">
     ...
     <div class="credits">
       ...
       Conçu par <a href="https://bootstrapmade.com/" target="_blank">BootstrapMade - Selecao</a> Distribué par <a
