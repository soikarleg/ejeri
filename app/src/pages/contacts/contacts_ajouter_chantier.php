...
$reqchantier = "SELECT * FROM client_chantier WHERE idcompte=:idcompte AND idcli = :idcli LIMIT 1";
...
<div class="row">
    ...
    <div class="col-md-4">
        <p class="titre_menu_item mb-2">Ajouter un chantier </p>
        <form action="/fiche_client?idcli=<?= $idcli ?>" autocomplete="off" id="form_adresse" method="post">
            ...
            <div class="input-group mb-2">
                ...
                <input type="text" class="form-control" id="adresse1" name="adresse" placeholder="Saisissez l'adresse" autocomplete="off" value="">

            </div>
            <div class="">
                <div class="input-group mb-2">
                    <span class="input-group-text l-9" id="basic-addon3">Ville</span>
                    <input type="text" class="form-control" id="ville1" name="ville" value="" readonly>
                </div>
                <div class="input-group mb-2">
                    <span class="input-group-text l-9" id="basic-addon3">Code Postal</span>
                    <input type="text" class="form-control" id="cp1" name="cp" value="" readonly>
                </div>
            </div>
            <!-- <div class="input-group mb-2">
                <span class="input-group-text l-9" id="basic-addon3">Portable</span>
                <input type="text" class="form-control" id="portable" name="portable" value="<?= str_replace('.', '', $portable) ?>" placeholder="Portable" onkeydown="Portable(this)" onkeypress="Portable(this)" onkeyup="Portable(this)">
            </div>
            <div class="input-group mb-2">
                <span class="input-group-text l-9" id="basic-addon3">Fixe</span>
                <input type="text" class="form-control" id="telephone" name="telephone" value="<?= str_replace('.', '', $telephone) ?>" placeholder="Fixe" onkeydown="Fixe(this)" onkeypress="Fixe(this)" onkeyup="Fixe(this)">
            </div>
            <div class="input-group mb-2">
            ...
            <div class="text-right">
                <p>
                    ...
                    <input type="hidden" class="form-control" name="ajouter_chantier" value="<?php echo md5('ajouter_chantier'); ?>" />
                    <input type="submit" class="btn btn-valider pull-right mt-2" value="Ajouter l'adresse du chantier" />
            ...
            fetchTrigger = setTimeout(function() {
                ...
                $.get('https://api-adresse.data.gouv.fr/search/', {
                    ...
                    $.each(data.features, function(i, obj) {
                        ...
                        let cooladdress = "<i class='bx bx-envelope icon-bar text-white'></i> " + obj.properties.name + "</br>" + obj.properties.postcode + " <strong>" + obj.properties.city + "</strong>";
