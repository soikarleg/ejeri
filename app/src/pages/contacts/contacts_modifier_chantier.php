...
$chantiers_adresse = $chantiers->chantierClientUnique($idcli, $idchantier);

?>
<div class="row">
  <div class="col-md-2"></div>
  <div class="col-md-4">
    <p class="titre_menu_item mb-2">Modifier l'adresse du chantier</p>
    <form autocomplete="off" id="form_chantier">
      ...
      <div class="input-group mb-2">
        ...
        <input type="text" class="form-control" id="adresse1" name="adresse" autocomplete="off" value="<?= $chantiers_adresse['chantier_adresse'] ?>">

      </div>
      <div class="">
        <div class="input-group mb-2">
          <span class="input-group-text l-9" id="basic-addon3">Ville</span>
          <input type="text" class="form-control" id="ville1" name="ville" value="<?= $chantiers_adresse['chantier_ville'] ?>" placeholder="Ville" readonly>
        </div>
        <div class="input-group mb-2">
          <span class="input-group-text l-9" id="basic-addon3">Code Postal</span>
          <input type="text" class="form-control" id="cp1" name="cp" value="<?= $chantiers_adresse['chantier_cp'] ?>" placeholder="Code postal" readonly>
        </div>
      </div>
      <div class="text-right">
        ...
        <div class="pull-right" style="display: flex; justify-content: flex-end; gap: 10px;">
          ...
          <input type="submit" class="btn btn-valider mt-2" value="Modifier l'adresse du chantier" />
