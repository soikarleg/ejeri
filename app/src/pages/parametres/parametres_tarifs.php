...
<p class="titre_menu_item mb-2">Tarif horaire de référence <span class="small text-muted">Applicable sur devis et factures pour les heures de main d'oeuvre</span></p>
<?php
  ...
  <div class="col-md-4">
    <form autocomplete="off" id="form">
      <div class="input-group mb-2">
        <span class="input-group-text l-9" id="basic-addon3">Euro/h TTC</span>
        <input type="text" class="form-control text-right" value="<?= $infos['tr'] ?>" id="tarif" name="tarif">
      ...
      <div class="text-right">
        <p>
          ...
          <input name="Envoyer" type="button" class="btn btn-mag-n text-primary" value="Valider le tarif" onclick="ajaxForm('#form', 'https://app.enooki.com/src/pages/parametres/parametres_inscription_tarif_bd.php', 'sub-target', 'attente_target');" />
        </p>
      </div>
    </form>
  </div>
