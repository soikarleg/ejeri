...
<p class="titre_menu_item mb-2">Devis <span class="small"></span></p>
  ...
  <div class="col-md-4">
    <form autocomplete="off" id="form">
      ...
      <div class="input-group mb-2">
        <span class="input-group-text l-160" id="basic-addon3">Racine *</span>
        <input type="text" class="form-control text-right" value="<?= $infos['dev_racine'] ?>" id="racine" name="racine">
        <input type="hidden" name="idcompte" value="<?= $secteur ?>" id="idcompte">
      </div>
      <div class="input-group mb-2">
        <span class="input-group-text l-160" id="basic-addon3">Validité *</span>
        <input type="text" class="form-control text-right" value="<?= $infos['valdev'] ?>" id="valdev" name="valdev">
        <input type="hidden" name="idcompte" value="<?= $secteur ?>" id="idcompte">
      </div>
