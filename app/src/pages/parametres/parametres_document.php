...
<p class="titre_menu_item mb-2">Documents <span class="small">Générés en .pdf</span></p>
    ...
    <form autocomplete="off" id="form">
      ...
      <div class="text-right">
        <p>
          ...
          <input name="Envoyer" type="button" class="btn btn-mag-n text-primary" value="Valider le taux de TVA" onclick="ajaxForm('#form', 'https://app.enooki.com/src/pages/parametres/parametres_inscription_tva_bd.php', 'sub-target', 'attente_target');" />
