...
<p class="titre_menu_item mb-2">Taux de TVA global <span class="small text-muted">Applicable sur devis et factures</span></p> -->
...
?>
<div class="">
  <div class=" border-dot-infos">
    <form autocomplete="off" id="form">


      <div class="input-group mb-2">
        <span class="input-group-text l-9" id="basic-addon3">TVA de réf. *</span>
        <input type="text" class="form-control text-right" value="<?= $infos['t7'] ?>" id="tva" name="tva">
      ...
      <div class="text-right">
        <p>
          ...
          <input name="Envoyer" type="button" class="btn btn-mag-n text-primary" value="Modifier" onclick="ajaxForm('#form', 'https://app.enooki.com/src/pages/parametres/parametres_inscription_tva_bd.php', 'sub-target', 'attente_target');" />
