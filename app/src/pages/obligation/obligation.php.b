...
$verif_users = $magesquo->bilanData($idcompte, 'users_infos');
...
<div class="row">
  ...
  <div class="col-md-4">
    ...
    ?>
    <p class="titre_menu_item mb-2">Informations personnelles de l'utilisateur - <?= $bilan_user ?></p>
  ...
  <div class="col-md-4">
    ...
    ?>
    <p class="titre_menu_item mb-2">Informations de l'entreprise - <?= $bilan_idcompte ?></p>
  ...
  $(function() {
    ...
    document.getElementById('siren_search').addEventListener('input', async function() {
      ...
      if (
        ...
        document.getElementById('adresse_ent').value = features.siege.numero_voie +
          ' ' + typeVoie + ' ' + features.siege.libelle_voie;
