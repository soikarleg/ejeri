...
$reqreg = "select id,numero,totttc,nom,datefact,factav,paye from facturesentete where
  cs='$secteur' and paye ='non' and annee='$annref' or
  cs='$secteur' and paye ='non' and annee='$ann'
  order by nom asc ";
$reglements = $conn->allRow($reqreg);
?>
<div class="row">
  <!-- <a href="" class="btn btn-mag-n">prevoir année ici <?= $annref ?></a> -->
  <div class="col-md-6">
    <p class="titre_menu_item mb-2">Pointage des règlements client de <?= $annref ?></p>
    ...
    <form id="formReg">
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" placeholder="..par N° facture ou nom" onmouseover="eff_form(this);" value="" aria-label="Username" aria-describedby="basic-addon1" id="valrech">
      </div>
            ...
            ?>
              ...
              ?>
                ...
                <tr class="trsoul">
                  ...
                  <td class=""><b> <?= $r['nom'] . ' ' . $client['prenom'] ?></b></br><span class="text-muted small"><?= $factav ?> N°</span> <span class="small text-primary text-bold numrem"><?= $r['numero'] ?></span><span class="text-muted small"> de <?= Dec_2($r['totttc']) ?>€ du <?= AffDate($r['datefact']) ?></span>
                    ...
                    ?>
                      </br><span class="small text-warning">Déjà payé : <?= Dec_2($ded, ' €') ?></span>
                    <?php
                    }
                    ?>
                  </td>
      ...
      <div class="">
        <div id="regliste"></div>
        <div class="container-fluid btn btn-mag mb-2 mt-4 text-bold text-warning" onclick="ajaxForm('#formReg','../src/pages/reglements/reglements_inscription_bd.php','sub-target','attente_target')"><span class="pull-right text-bold text-warning" id="totalrem">0.00</span>Enregistrer la remise de : </div>
