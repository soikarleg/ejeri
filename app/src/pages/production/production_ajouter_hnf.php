...
<div class="">
  <div class="row">
    ...
    <div class="col-md-3">
      <p class="titre_menu_item mb-2 text-danger">Heures non facturables</p>
      <form method="POST" id="form_prod">
        ...
        <div class="input-group mb-2">
          ...
          <select class="form-control" id="stype">
            ...
            <?php
            echo $reqtitre = "select * from devistitres where cs like '$secteur' and type like 'NF' order by titre asc";
        ...
        <p class="text-right">
          ...
          <input name="codeprod" id="codeprod" type="hidden" value="NF">
          <input name="factok" id="factok" type="hidden" value="oui">
        </p>
