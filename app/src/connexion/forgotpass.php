...
<div class="container pt-5">
  <div class="row">
    ...
    <div class="col-md-4 text-center">
      ...
      <h3 class="text-primary mb-3">Mot de passe oublié</h3>
      <p class="small text-muted mb-3">Vous allez recevoir un mail de réinitialisation.</p>
      <form autocomplete="off" action="/oubli" method="post" id="forgot">
        <div class="mb-2">
          <input type="email" class="form-control" id="email" name="email_reinit" placeholder="Email" onkeydown="Email(this)" onkeypress="Email(this)" onkeyup="Email(this)" autocomplete="off">
          <input type="hidden" name="oubli" value="mdp_oubli">
        </div>
        <div class="mb-4">
